import{r as c,a as y,j as t,F as w}from"./main-BXkGyteG.js";import{f as N,a as m}from"./devisUtils-Bdh2_MXj.js";import{S as $}from"./clientAmountUtils-Y5aAeph3.js";import{S as T}from"./search-DQQ-cTRK.js";import{R as C}from"./refresh-cw-DUdF5OSh.js";import{P as D}from"./printer-CI6SOIot.js";/* empty css            */const A={date_from:"",date_to:"",client_name:"",city:""};function l(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function i(a){return(Number(a)||0).toLocaleString("fr-FR",{minimumFractionDigits:2,maximumFractionDigits:2})}function S(a){const s=(a.items||[]).map(r=>{const d=r.type_travaux?.trim();return`
<tr>
