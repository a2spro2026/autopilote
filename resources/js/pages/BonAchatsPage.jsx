...
<h1>Autopilote — Bon d'Achat <span class="badge">${row.reference}</span></h1>
<table>
                            ...
                            {loading ? (
                                ...
                                rows.map((row) => (
                                    <tr key={row.id} className={`hover:bg-orange-50/40 dark:hover:bg-slate-800/40 transition-colors ${editingId === row.id ? 'bg-amber-50/60 dark:bg-amber-900/10' : ''}`}>
                                        ...
                                        <td className="px-4 py-2.5 text-center text-slate-400 dark:text-slate-500 opacity-50" title="Section à venir">—</td>
                                        <td className="px-4 py-2.5 text-center text-slate-400 dark:text-slate-500 opacity-50" title="Section à venir">—</td>
